                ...
                <div className="grid grid-cols-4 gap-2">
                  {AVAILABLE_CHARACTERS.map((charId) => {
                    const isTaken = players.some(
                      (p) => p.characterId === charId && p.userId !== userId
                    )
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          ...
                          <div
                            className={`w-2 h-2 rounded-full ${difficultyColors[level.difficulty as keyof typeof difficultyColors]}`}
                          />
                        </div>
                  ...
                  <div className="mt-4 p-3 bg-muted/30 rounded-lg border border-dashed">
                    <div className="flex justify-between items-center">
                      ...
                      <Badge
                        className={
                          difficultyColors[
                            selectedLevelData.difficulty as keyof typeof difficultyColors
                          ]
                        }
                      >
